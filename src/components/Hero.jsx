...
import heroVideo from '../assets/hero video/Young_woman_speaking_portfolio_202606082340.mp4';
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <video
        ...
        muted={isMuted}
        playsInline
        className="absolute top-0 left-0 w-full h-full object-cover object-[50%_center] md:object-center z-0"
      >
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            Hi, I am  <br /> <span className="text-transparent [-webkit-text-stroke:1.5px_white]">Sejal Kamble</span>
          </h1>
          ...
          >
            Aspiring Software Engineer and Full Stack Developer, dedicated to crafting clean, functional, and highly scalable web applications.
          </p>
